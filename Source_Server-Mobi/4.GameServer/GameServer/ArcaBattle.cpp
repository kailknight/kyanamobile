...
void CArcaBattle::ProcState_EMPTY() // OK
{
	...
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3000));
...
void CArcaBattle::ProcState_SIGN1() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3001));
...
void CArcaBattle::ProcState_SIGN2() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3002));
...
void CArcaBattle::ProcState_READY() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3003));
...
void CArcaBattle::ProcState_PARTY() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3004));
...
void CArcaBattle::ProcState_START() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3005));
...
void CArcaBattle::ProcState_CLOSE() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3006));
...
void CArcaBattle::ProcState_CLEAN() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3007));
...
void CArcaBattle::ProcState_CLEAR() // OK
{
	...
	if(this->m_RemainTime <= 0)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(3008));
