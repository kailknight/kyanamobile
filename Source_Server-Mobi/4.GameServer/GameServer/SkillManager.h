...
public:
	...
	bool SkillSwordPowerGetPhysiDamage(int aIndex, __int64* DamageMin, __int64* DamageMax);
	bool SkillSwordPowerGetMagicDamage(int aIndex, __int64* DamageMin, __int64* DamageMax);
	bool SkillSwordPowerGetCurseDamage(int aIndex, __int64* DamageMin, __int64* DamageMax);
