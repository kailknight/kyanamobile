...
void CNotice::Load(char* path) // OK
{
	...
	// Restart the rotation as well. Without this a reload that shortens the
	// list leaves the cursor past the new end, and the next tick broadcasts a
	// notice that was just deleted.
	this->m_NoticeValue = 0;
