...
public:
	...
	ITEM_OPTION0_RATE_INFO* GetRawOption0(int index);
	ITEM_OPTION1_RATE_INFO* GetRawOption1(int index);
	ITEM_OPTION2_RATE_INFO* GetRawOption2(int index);
	ITEM_OPTION3_RATE_INFO* GetRawOption3(int index);
	ITEM_OPTION4_RATE_INFO* GetRawOption4(int index);
	ITEM_OPTION5_RATE_INFO* GetRawOption5(int index);
	ITEM_OPTION6_RATE_INFO* GetRawOption6(int index);
private:
