...
namespace SEASON3B
{
...
#if(HAISLOTRING)
		EQUIPMENT_ITEM m_EquipmentSlotsMuun[16];
		int	 m_iPointedSlotMuun;
#endif
		int	 m_iPointedSlot;
	...
	public:
		...
		int FindItemIndex(short int siType, int iLevel = -1, bool InvExt = false) const;
		...
		void BMoveItemNew(int Type);
		int SlotAutoMove;
		bool CheckIsToolTip() const;
	protected:
