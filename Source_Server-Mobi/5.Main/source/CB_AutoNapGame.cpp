...
char* mTextStatus[] = { "Quet QR", "Hoan Tat", "Da Huy" };
int NumberQR = -1;
...
void CBAutoNapGame::DrawQRCodeThanhToan()
{
	...
	if (g_pBCustomMenuInfo->gDrawWindowCustom(&StartX, &StartY, WindowW, WindowH, eWindowQRCode, gOther.TextVN_NAPGAME[0]))
	{
		...
		//===Info Bank
		TextDraw((HFONT)g_hFontBold, StartXInfo, StartYInfo, 0xFFDE26FF, 0x3a4b3978, WInfo, 0, 3, gOther.TextVN_NAPGAME[1]); //"Th么ng Tin");
