...
void CBBossGuild::DrawWindow()
{
	...
	{
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "- Tieu diet cac Boss Phu Thuy, Chien Binh, Tien Nu"); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?M峄梚 th脿nh vi锚n s岷?膽em l岷 %d 膽i峄僲 Guild chi岷縩 th岷痭g", gCBBossGuild->Score); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?M峄梚 th脿nh vi锚n s岷?nh岷璶 膽瓢峄 %d Wcoi khi Guild chi岷縩 th岷痭g", gCBBossGuild->WCoinC); //

		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?Nh芒n v岷璽 ti锚u di峄噒 Boss Ph霉 Th峄 s岷?nh岷璶 膽瓢峄 %d Wcoi", gCBBossGuild->PhuThuyWCoinC); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?Nh芒n v岷璽 ti锚u di峄噒 Boss Chi岷縩 Binh s岷?nh岷璶 膽瓢峄 %d Wcoi", gCBBossGuild->ChienBinhWCoinC); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?Nh芒n v岷璽 ti锚u di峄噒 Boss Ti锚n N峄?s岷?nh岷璶 膽瓢峄 %d Wcoi", gCBBossGuild->TienNuWCoinC); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, 0x0, CuaSoW, 0, 1, ""); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eRed, CuaSoW, 0, 1, "=> L漂U 脻 H脙Y 膼I C浓NG GUILD 膼峄?TR脕NH 膫N H脌NH NG岷琍 M峄扢 <="); //
	}

	if (gCBBossGuild->CheDo2 == 1)
	{
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "- Tieu diet cac Boss Thuat Si, Thiet Binh, Dau Si, Chua Te"); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?M峄梚 th脿nh vi锚n s岷?膽em l岷 %d 膽i峄僲 Guild chi岷縩 th岷痭g", gCBBossGuild->Score); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?M峄梚 th脿nh vi锚n s岷?nh岷璶 膽瓢峄 %d Wcoi khi Guild chi岷縩 th岷痭g", gCBBossGuild->WCoinC); //

		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?Nh芒n v岷璽 ti锚u di峄噒 Boss Thu岷璽 S末 s岷?nh岷璶 膽瓢峄 %d Wcoi", gCBBossGuild->ThuatSiWCoinC); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?Nh芒n v岷璽 ti锚u di峄噒 Boss Thi岷縯 Binh s岷?nh岷璶 膽瓢峄 %d Wcoi", gCBBossGuild->ThietBinhWCoinC); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?Nh芒n v岷璽 ti锚u di峄噒 Boss 膼岷 S末 s岷?nh岷璶 膽瓢峄 %d Wcoi", gCBBossGuild->DauSiWCoinC); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eExcellentS15, CuaSoW, 0, 1, "鈥?Nh芒n v岷璽 ti锚u di峄噒 Boss Ch煤a T峄?s岷?nh岷璶 膽瓢峄 %d Wcoi", gCBBossGuild->ChuaTeWCoinC); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, 0x0, CuaSoW, 0, 1, ""); //
		TextDraw(g_hFont, (StartX + (CuaSoW / 10)) - 30, TextStartY + (12 * ct++), 0xEBFFFBFF, eRed, CuaSoW, 0, 1, "=> L漂U 脻 H脙Y 膼I C浓NG GUILD 膼峄?TR脕NH 膫N H脌NH NG岷琍 M峄扢 <="); //
	}
...
void CBBossGuild::DrawBossGuildMap()
{
	...
	if (gMapManager.WorldActive == 105)
	{
		...
		TextDraw(g_hFontBold, InfoX, InfoY + 20, 0xE6FCF7FF, 0x00FFE564, InfoW + 7, 0, 3, "Th峄漣 gian c貌n l岷");
