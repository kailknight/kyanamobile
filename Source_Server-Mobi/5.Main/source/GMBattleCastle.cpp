...
//        case    18 :
    ...
    CHARACTER* CreateBattleCastleMonster ( int Type, int PositionX, int PositionY, int Key )
    {
        ...
        case 215:
		    ...
		    c->Weapon[0].Type = -1;
		    c->Weapon[1].Type = -1;
 			strcpy(c->ID, "BattleCastleMonster");
            break;
