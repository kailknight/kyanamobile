...
void BCreateGuildMark(BYTE* MarkBuffer, bool blend = true);
...
void RenderItemNameS6(int i, ITEM_t pItem,int ItemLevel,int ItemOption,int ItemExtOption,bool Sort); //== Fix RenderItemName
