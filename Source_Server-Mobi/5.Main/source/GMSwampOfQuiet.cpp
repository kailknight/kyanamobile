...
// 	switch(pObject->Type)
// 	{
// 	case 2:		// 娴犳﹢妲曢弫?閼芥劘鍋?// 		if (!bSafeZone)
...
// 	if(pObject->Type == 2 || pObject->Type == 53 || pObject->Type == 55 || pObject->Type == 89 || pObject->Type == 125 || pObject->Type == 128)	// 濮樻柨娅掗幏?,2, 閼芥劘鍋? 闂嗏偓閸у嘲绨? 閾?// 	{
...
CHARACTER* GMSwampOfQuiet::CreateSwampOfQuietMonster(int iType, int PosX, int PosY, int Key)
{
	...
	case 441:
		...
		strcpy(pCharacter->ID,"SwampMonster1");
...
// 		}
	...
	case 442:
		...
		strcpy(pCharacter->ID,"SwampMonster8");
		pCharacter->Object.Scale = 1.0f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
// 		{
...
// 		}
	...
	case 443:
		...
		strcpy(pCharacter->ID,"SwampMonster2");
		pCharacter->Object.Scale = 1.0f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
// 		{
...
// 		}
	...
	case 444:
		...
		strcpy(pCharacter->ID,"SwampMonster4");
	...
	case 445:
		...
		strcpy(pCharacter->ID,"SwampMonster3");
		pCharacter->Object.Scale = 1.1f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		pCharacter->Object.LifeTime = 100;
	...
	case 446:
		...
		strcpy(pCharacter->ID,"SwampMonster5");
	...
	case 447:
		...
		strcpy(pCharacter->ID,"SwampMonster6");
	...
	case 448:
		...
		strcpy(pCharacter->ID,"SwampMonster7");
		pCharacter->Object.Scale = 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 449:
		...
		strcpy(pCharacter->ID,"SwampMonster9");
		pCharacter->Object.Scale = 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 561:
		...
		strcpy(pCharacter->ID,"SwampMonster10");
	...
	case 560:
		...
		strcpy(pCharacter->ID,"SwampMonster11");
		pCharacter->Object.Scale = 1.5f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 558:
		...
		strcpy(pCharacter->ID,"SwampMonster12");
		pCharacter->Object.Scale = 1.1f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 559:
		...
		strcpy(pCharacter->ID,"SwampMonster13");
	...
	case MODEL_MONSTER01 + 138:
	{
			...
			|| (pObject->AnimationFrame >= Start_Frame && pObject->AnimationFrame <= End_Frame && pObject->CurrentAction == MONSTER01_ATTACK2))
		{
			...
			for (int i = 0; i < 10; i++)
			{
				...
				// 閸濐參顣?				pModel->TransformPosition(BoneTransform[42], StartRelative, StartPos, false);
