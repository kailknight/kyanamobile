...
bool	CShopPackage::SetPackage(std::string strdata) // OK
{
	...
	StringCchCopyA(this->PackageProductName,sizeof(this->PackageProductName),token.nextToken().c_str());
	this->PackageProductType = atoi(token.nextToken().c_str());
	this->Price = atoi(token.nextToken().c_str());
	StringCchCopyA(this->Description,sizeof(this->Description),token.nextToken().c_str());
	StringCchCopyA(this->Caution,sizeof(this->Caution),token.nextToken().c_str());
	...
	StringCchCopyA(this->ProductCashName,sizeof(this->ProductCashName),token.nextToken().c_str());
	StringCchCopyA(this->PricUnitName,sizeof(this->PricUnitName),token.nextToken().c_str());
